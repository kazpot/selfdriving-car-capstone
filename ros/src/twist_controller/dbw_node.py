...
class DBWNode(object):
    def __init__(self):
        ...
        self.controller = Controller(wheel_base, steer_ratio, 0.1, max_lat_accel,  max_steer_angle, vehicle_mass, brake_deadband, wheel_radius)
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.current_velocity is not None and self.target_velocity is not None:
                ...
                throttle, brake, steering = self.controller.control(current_velocity, linear_velocity, angular_velocity)
